...
export default function EmployerAddEventPage() {
  ...
  const onSubmit = async (data: EventForm) => {
    if (!employerId) {
      alert("You must be signed in as an employer to post an event.");
      return;
    }
    ...
    const eventData = {
      ...
      poster_url: null, // TODO: handle file upload if needed
